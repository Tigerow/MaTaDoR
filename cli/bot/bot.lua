...
chats = {}
plugins = {}
helper_id = 11111111111 --Put Your Helper Bot ID Here
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {417478219,423308552},
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[》MegaSpeed Cli 
An advanced sudoistration bot based on https://valtman.name/telegram-cli

》https://github.com/MegaSpeeed/megaspeeed
